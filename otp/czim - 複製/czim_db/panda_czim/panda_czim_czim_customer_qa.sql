...
--
-- Table structure for table `czim_customer_qa`
--

DROP TABLE IF EXISTS `czim_customer_qa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `czim_customer_qa` (
...
--
-- Dumping data for table `czim_customer_qa`
--

LOCK TABLES `czim_customer_qa` WRITE;
UNLOCK TABLES;
