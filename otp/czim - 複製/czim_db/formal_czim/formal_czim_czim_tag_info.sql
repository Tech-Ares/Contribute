...
--
-- Table structure for table `czim_tag_info`
--

DROP TABLE IF EXISTS `czim_tag_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `czim_tag_info` (
  `Id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '视频标签信息',
  `TagName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '标签说明',
  `TagType` int DEFAULT NULL COMMENT '标签类型\r\n1：系统标签\r\n2：自定义标签\r\n3：用户自定义标签',
  `TagImg` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '标签贴图',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='视频标签信息';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `czim_tag_info`
--

LOCK TABLES `czim_tag_info` WRITE;
UNLOCK TABLES;
