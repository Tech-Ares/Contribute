...
namespace KUX.Infrastructure.ScanDIService;
...
public class DIServiceScanningProvider
{
    ...
    /// 开始扫描
    /// </summary>
    public void Start(IServiceCollection serviceCollection, string assemblyFilter = "KUX.")
    {
        ...
        foreach (var item in assemblies)
        {
            var classList = item.ExportedTypes
                .Where(w => w.GetCustomAttribute<DIServiceAttribute>() != null ||
                w.BaseType?.GetCustomAttribute<DIServiceAttribute>() != null);
        ...
        #endregion AppService 特性 方式 自动注册
    }
