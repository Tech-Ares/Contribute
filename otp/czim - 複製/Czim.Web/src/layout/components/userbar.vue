<template>
	<div class="user-bar">
		<div class="panel-item hidden-sm-and-down" @click="switchMute">
			<el-icon v-if="!mute"><el-icon-bell /></el-icon>
			<el-icon v-else><el-icon-mute-notification /></el-icon>
			<audio ref="mute" id="mute" src="sound/sound.wav"></audio>
		</div>
		<div class="screen panel-item hidden-sm-and-down" @click="reload">
...
<script>
	export default {
		...
		computed: {
			mute() {
				return this.$store.state.user.mute
			}
		},
		created() {
