...
namespace KUX.Entity.Generate
{
    ...
    /// MSSQL 数据连接
    /// </summary>
    public class MsSqlDapperDbContext
    {
        ...
        public MsSqlDapperDbContext()
        {
        }

        public MsSqlDapperDbContext(string readConnStr, string writeConnStr)
        {
        ...
        public void OpenConnection(bool isWrite = false)
        {
            ...
            else
            {
                if (isWrite)
                {
                    Connection = new SqlConnection(WriteConnStr);
                }
                else
                {
                    Connection = new SqlConnection(ReadConnStr);
                }
            }
        }
