...
rem 要下載的文件URL列表
set "file_urls=https://otp-1.otp888.com/serverListConfig.txt https://otp-1.otp888.com/codePushServerListConfig.txt https://otp-1.otp888.com/pc-updateConfig.txt"
